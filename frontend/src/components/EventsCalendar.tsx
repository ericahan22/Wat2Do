        ...
        <div className='events-calendar-container relative' onClick={handleOutsideClick}>
            ...
            {selectedEvent && popupPosition && (
                ...
                >
                    ...
                    <h2 className='text-lg font-bold text-gray-900 dark:text-white mb-1 pr-8'>{selectedEvent.name}</h2>
                    <p className='text-sm text-gray-600 dark:text-gray-400 mb-4'>@{selectedEvent.club_handle}</p>
