...
def setup_zyte():
    ...
    sys_cafile = ssl.get_default_verify_paths().cafile or "/etc/ssl/certs/ca-certificates.crt"
    ...
    if zyte_cert.exists():
        try:
            ...
            logger.error(f"Failed to create Zyte CA bundle: {e}, falling back to zyte-ca.crt")
            cert_path = zyte_cert
