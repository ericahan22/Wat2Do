...
def test_similarity(request):
    ...
    try:
        ...
        similar_events = find_similar_events(search_embedding, threshold=threshold, limit=limit)
...
def get_google_calendar_urls(request):
    ...
    try:
        ...
        for event in events:
            ...
            google_calendar_url = f"https://calendar.google.com/calendar/render?{urlencode(params)}"
