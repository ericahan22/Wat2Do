...
urlpatterns = [
    ...
    path("events/<int:event_id>/unpromote/", views.unpromote_event, name="unpromote_event"),
    path("events/<int:event_id>/promotion-status/", views.get_promotion_status, name="get_promotion_status"),
]
